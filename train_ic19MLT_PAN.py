...
def main(args):
    if args.checkpoint == '':
        args.checkpoint = "checkpoints1/ic19_%s_bs_%d_ep_%d"%(args.arch, args.batch_size, args.n_epoch)
    if args.pretrain:
...
if __name__ == '__main__':
    ...
    parser.add_argument('--arch', nargs='?', type=str, default='resPAnet50')
